...
<div class="row">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title m-b-20">New Publisher</h4>
                <form action="{{ route('publishers.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="company_name"
                               ...
                               value="{{ old('company_name') }}" placeholder="e.g. Sony Interactive">
                        @error('company_name')
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email"
                               ...
                               value="{{ old('email') }}" placeholder="contact@publisher.com">
                        @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" name="contact_number"
                               class="form-control"
                               value="{{ old('contact_number') }}" placeholder="+1 234 567 890">
                    </div>
                    <div class="form-group">
                        <label>Address</label>
